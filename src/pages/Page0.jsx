  ...
  return (
    <div className="fade-in">
      <div style={{ textAlign: "center", marginBottom: "1rem" }}>
        <img src="/Logo.png" alt="University Logo" style={{ maxWidth: "150px", height: "auto" }} />
      </div>
      ...
      <div className="glass-panel" style={{ lineHeight: "1.7", marginBottom: "2rem", padding: "1.5rem", background: "#f8fafc" }}>
        <p style={{ marginBottom: "1rem", textIndent: "2rem" }}>
          งานวิจัยอิสระนี้เป็นส่วนหนึ่งในการศึกษาค้นคว้าอิสระตามหลักสูตรเศรษฐศาสตร์มหาบัณฑิต สาขาเศรษฐศาสตร์ธุรกิจ โดยมีวัตถุประสงค์หลักเพื่อศึกษาเกี่ยวกับอิทธิพลของอคติทางความคิดว่ามีผลต่อการเลือกซื้อสลากกินแบ่งรัฐบาลแบบกำหนดตัวเลขด้วยตนเอง หากแบบสอบถามดังกล่าวมีข้อผิดพลาด หรือปัญหาประการใดสามารถติดต่อ อาจารย์ที่ปรึกษา ผศ.ดร.ลอยลม ประเสริฐศรี loylom@econ.tu.ac.th
        </p>
        <p style={{ textIndent: "2rem" }}>
          งานวิจัยนี้เป็นงานวิจัยเชิงสำรวจ ทำการเก็บข้อมูลโดยใช้แบบสอบถามออนไลน์ โดยแบ่งออกเป็น  6 ส่วน ดังนี้
        </p>

        <ul style={{ paddingLeft: "1.5rem", marginBottom: "1.5rem", marginTop: "1rem" }}>
          <li style={{ marginBottom: "0.5rem" }}><strong>ส่วนที่ 1:</strong> ปัจจัยทางประชากรศาสตร์ </li>
        ...
        <p style={{ fontSize: "0.9rem", color: "var(--text-light)", fontStyle: "italic", margin: 0, padding: "1rem", background: "#f1f5f9", borderRadius: "8px" }}>
          <strong>*หมายเหตุ:</strong> รูปแบบบุคคลสมมติ (สไตย์นักช็อปสลากของคุณ) ที่ปรากฏ เป็นเพียงส่วนเสริมที่ผู้วิจัยออกแบบไว้เพื่อความบันเทิงที่ผู้ตอบแบบสอบถามให้ความกรุณาตอบแบบสอบถามนี้จนสิ้นสุดการทำแบบสอบถาม ผลลัพธ์ที่แสดงผลออกมาไม่สามารถนำไปใช้อ้างอิงถึงบุคลิกภาพ นิสัย หรือระบุตัวตนที่แท้จริงของผู้ร่วมตอบแบบสอบถามได้
        </p>
      </div>
